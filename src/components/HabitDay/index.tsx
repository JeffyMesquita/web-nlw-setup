...
export function HabitDay({
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        className={clsx(
          'w-10 h10 border-2 rounded-lg hover:border-zinc-400 transition-all duration-1000 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background',
          {
